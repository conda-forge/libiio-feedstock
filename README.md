...
Once the `conda-forge` channel has been enabled, `libiio, libiio-c, pylibiio` can be installed with `conda`:
...
It is possible to list all of the versions of `libiio` available on your platform with `conda`:
